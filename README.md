...
### Вариант 1: Использование через CDN (скоро)
```html
<script type="module" src="https://cdn.example.com/zh-mr-slider.js"></script>
```
...
### JavaScript API
```javascript
const slider = document.querySelector('ugo-mr-slider');
